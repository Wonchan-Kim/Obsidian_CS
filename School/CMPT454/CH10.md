...
To understand this case, consider the intermediate right subtree shown above. We would arrive at the same intermediate right subtree if we try to delete 24 from tree 